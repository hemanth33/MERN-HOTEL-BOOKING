...
const BookingForm = ({ currentUser, paymentIntent }: Props) => {
    ...
    return (
        ...
        <div className="space-y-2">
            ...
            <CardElement id="paymentElement" className="border rounded-md p-2 text-sm"/>
        </div>

        <div className="flex justify-end">
            <button className="bg-blue-600 p-2 text-white font-bold hover:bg-blue-500 text-md disabled:bg-gray-500" type="submit" disabled={isLoading}>
